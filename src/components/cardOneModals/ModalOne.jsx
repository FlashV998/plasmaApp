...
// this.uploadFilesOnS3=this.uploadFilesOnS3.bind(this)
    ...
    handleFileChange(event) {
      ...
      // uploadFilesOnS3() {
      //   //service to get url of image
      //   const fileData = new FormData();
      //   var uploadedFiles = [];
      //   // console.log(this.state.fileUrls);
      //   this.state.fileUrls.map(fileUrl => fileData.append("file", fileUrl));
      //   // console.log(fileData);
      //   imageAPI.post(`userprofile/uploadimage`, fileData).then(res => {
      //     // console.log(res.data);
      //     uploadedFiles = res.data["Data"];
      //     this.setState({ fileUrls: [] });
      //     this.props.receiveImages(uploadedFiles);
             
      //     this.props.submitArtistDetails(uploadedFiles);
      //   });
      // }
